...
class OpenvSwitchNetwork(LXDModule):
    ...
    def createNetwork(self, input, name):
        try:
            ...
            return self._executeLXCNetworkTerminal(self._formToLXCSetTask(input), name, input['openvswitch'])
        except Exception as e:
    ...
    def _executeLXCNetworkTerminal(self, lines_to_exec, name, openvswitch=False):
        ...
        if openvswitch:
            p = subprocess.Popen(["lxc", "network", "set", name, "bridge.driver", "openvswitch"],
                                 stdout=subprocess.PIPE)
        else:
            p = subprocess.Popen(["lxc", "network", "set", name, "bridge.driver", "native"],
                                 stdout=subprocess.PIPE)
